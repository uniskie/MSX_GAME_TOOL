...
SET VOL=5
SET DISC=2
SET TITLE=マクロス カウントダウン
SET G=MACROSDS

REM ROM IMAGE: +9C000 size:8000H
REM (CLUSTER:619 / SECTOR:4E0H)
...
REM BODY: 4010H-7FFFH SIZE:(8000H-10H)
REM +10 size:7FF0
BINCUT2 -s 10 -l 7FF0 -o %G%_BODY.BIN %G%_RAW.ROM
IF ERRORLEVEL 1 GOTO :err_end
...
ECHO 41 42 10 40 00 00 00 00 00 00 00 00 00 00 00 00 >%G%_HEAD.TXT

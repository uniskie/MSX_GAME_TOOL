...
SET VOL=2
SET DISC=2
SET TITLE=窓ふき会社のスイング君
SET G=SWING_DS

REM ROM IMAGE: +80000H size:4000H
REM (CLUSTER:507 / SECTOR:400H)
...
REM BODY: 0000H- SIZE:(4000H-4)
BINCUT2 -s 0 -l 3FFB -o %G%_BODY.BIN %G%_RAW.ROM
IF ERRORLEVEL 1 GOTO :err_end

...
ECHO.
ECHO RequiredF
ECHO    RuneWorth_S.dsk ... System Disk disk-image
...
ECHO    (77*2=154 songs exceeds the file limit for MSX-DOS)
ECHO.
ECHO    for OPLL: %DIR_F%
ECHO    for PSG : %DIR_P%
REM *****************************************************************
...
ECHO.
ECHO *****************************************************************
ECHO * use OPLL.COM / PSG.COM provided by T^&E SOFT for playing.
ECHO * Collection: MSXFAN June 1995 "Undead Line" BGM tool set
ECHO *****************************************************************

# KSS File Extraction Kit for Rune Worth (MSX2)
...
成功すると
- `RuneWorh_opll` フォルダにOPLL用mdtファイル
- `RuneWorh_psg` フォルダにPSG用mdtファイル
がそれぞれ出力されていると思います。

[MSXFAN 1995年6月号付録のアンデッドラインBGMツール一式](#アンデットラインbgm集mml開発キット)に同梱の
- PSG.COM
- OPLL.COM
...
## 「アンデットライン」BGM集&MML開発キット


MSXFAN 1995年6月号 付録ディスク「すぺしゃる」コーナーに、
**「アンデットライン」BGM集&MML開発キット一式**
が収録されています。
